...
const Welcome = () => {
    ...
    return(
        ...
        <div className='flex w-full justify-center'>
            ...
            <div className='flex mf:flex-row flex-col items-start justify-between md:p-10 px-12 py-4'>
                ...
                <div className='flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10'>
                    ...
                    <div className="p-3 justify-end items-sart flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card white-glassmopism">
                    ...
                    <Input placeholder="Enter Message" name="message" type="text" handleChange={handleChange} />
                        ...
                        {isLoading ? (
                            ...
                            <button className='text-white w-full mt-2 border-[1px] p-2 border-[#3d4f7c] hover:bg-[#3d4f7c] rounded-full cursor-pointer' type='button' onClick={handleSubmit}>
                                Send Now
                            </button>
                        ) }
